export function ArrowControl({
  ...
  return (
    <button
      ...
      className="group absolute top-1/2 right-5 z-40 grid h-12 w-12 -translate-y-1/2 place-items-center rounded-full border backdrop-blur-sm transition-all duration-500 hover:scale-105 focus-visible:ring-2 focus-visible:outline-none md:right-10 md:h-14 md:w-14"
      style={{
